...
mkDRRandRule2 :: LNTerm -> LNTerm -> LNTerm -> LNTerm -> LNTerm -> IntrRuleAC
mkDRRandRule2 t_prem t_prem2 t_prem3 t_prem4 t_conc =
...
-- (m, r, sk)
mkDRDecRule2 :: LNTerm -> LNTerm -> LNTerm -> LNTerm -> IntrRuleAC
mkDRDecRule2 t_prem t_prem2 t_prem3 t_conc =
